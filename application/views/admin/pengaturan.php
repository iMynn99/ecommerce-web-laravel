		...
		<div class="container m-b-75">
			...
			<div class="tab">
				<div class="tab-header">
					<a class="navlink btn btn-primary m-r-8 m-b-8" href="javascript:void(0)" data-link="#saldo"><i class="fas fa-wallet"></i> Saldo <?php echo $this->func->globalset("nama"); ?></a>
					<a id="navrekening" class="navlink klikrek btn btn-light m-r-8 m-b-8" href="javascript:void(0)" data-link="#rekening"><i class="far fa-credit-card"></i> Rekening</a>
					<a id="navalamat" class="navlink btn btn-light m-r-8 m-b-8" href="javascript:void(0)" data-link="#alamat"><i class="fas fa-house-user"></i> Alamat</a>
					<a id="navinformasi" class="navlink btn btn-light m-r-8 m-b-8" href="javascript:void(0)" data-link="#informasi"><i class="fas fa-users-cog"></i> Pengaturan Akun</a>
						...
						<div class="section row m-lr-0 m-t-30 m-b-40 p-tb-20 p-lr-20">
							<div class="col-md-8 m-lr-auto">
								<div class="p-tb-20">
									...
									<div class="fs-24 font-bold text-primary"><?=strtoupper(strtolower($pro->nama))?></div>
							...
							<div class="col-md-4 m-lr-auto">
								<div class="p-tb-20">
									...
									<div class="fs-32 font-bold text-success m-b-30"><b>Rp <?php echo $this->func->formUang($this->func->getSaldo($_SESSION["usrid"],"saldo","usrid")); ?>,-</b></div>
									<div class="row">
										<div class="col-6">
