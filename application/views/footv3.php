		...
		<div class="row p-b-90 container m-l-auto m-r-auto">
			<div class="col-md-3 m-b-20">
				...
				<div class="m-b-20">
					...
					&nbsp;
					<table>
						<tr><td class='p-r-10'><i class="fas fa-phone color1"></i></td><td><?=$set->wasap?></td></tr>
						<tr><td class='p-r-10'><i class="fab fa-instagram"></i> </td><td>@<?=$set->instagram?></td></tr>
						<tr><td class='p-r-10'><i class="fas fa-envelope-open"></i> </td><td><?=$set->email?></td></tr>
						<tr><td class='p-r-10'><i class="fas fa-map-marker-alt"></i> </td><td><?=$set->alamat?></td></tr>
					</table>
				</div>
				<div class="m-b-20">
				...
				<div class="p-t-10">
					<?php
						...
						for($i=0; $i<count($kurir); $i++){
							...
							if(file_exists(FCPATH."cdn/assets/img/kurir/".$kur.".png")){
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="p-all-28 text-center">
						...
						<small>atau</small><br/>
						<a href="https://member.jadiorder.com" target="_blank"><i class="fas fa-arrow-right"></i> https://member.jadiorder.com</a>
						<br/>&nbsp;<br/>
