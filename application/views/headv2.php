                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="<?= site_url() ?>">
                                <i class="fas fa-home text-primary mr-2"></i> Beranda
                            </a>
                        </li>

                        <!-- Menu Kategori Dinamis -->
                        <?php
        $kategori = $this->db->get("kategori"); // ambil data kategori dari tabel
        foreach ($kategori->result() as $kat) {
            $slug = strtolower(url_title($kat->nama, 'dash', TRUE)); // pastikan slug aman untuk URL
        ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= site_url('kategori/' . $slug) ?>">
                                <?= $kat->nama ?>
                            </a>
                        </li>
                        <?php } ?>
                    ...
                    <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?= site_url('manage/pesanan') ?>">
                                <i class="fas fa-shopping-bag text-primary"></i> Pesanan
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" onclick="signoutNow()">
