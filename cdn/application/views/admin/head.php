...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>assets/css/util.css?v=<?=time()?>">
            ...
            <div class="logo-header">
                <a href="<?=site_url()?>" class="logo">
                    <img src="<?=base_url("assets/img/".$this->func->globalset("logo"))?>"
                        style="height: 40px;margin: -12px 0 -8px 0" />
                </a>
            ...
            <nav class="navbar navbar-header navbar-expand-lg">
                <div class="container-fluid">
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item">
                            <a class="nav-link" href="<?=$this->func->mainsite_url()?>" target="_blank">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <img src="<?=base_url()?>assets/img/user.png" alt="user-img" width="36"
                                    class="img-circle">
