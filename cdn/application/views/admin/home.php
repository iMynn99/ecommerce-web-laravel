<?php
	...
	foreach($trx->result() as $r){
		...
		$tgln = $this->func->ubahTgl("d-m",$r->tgl);
		...
		<div class="card card-stats card-success">
			<div class="card-body">
				...
				<div class="numbers border-top p-t-10">
					...
					<p class="card-category">Omset Rp. <?=$this->func->formUang($omsettoday)?></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="card card-stats card-info">
			<div class="card-body">
				...
				<div class="numbers border-top p-t-10">
					...
					<p class="card-category">Omset Rp. <?=$this->func->formUang($omsetkemarin)?></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="card card-stats card-primary">
			<div class="card-body">
				...
				<div class="numbers border-top p-t-10">
					...
					<p class="card-category">Omset Rp. <?=$this->func->formUang($omsetbulan)?></p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="card card-stats card-warning">
			<div class="card-body">
				...
				<div class="numbers border-top p-t-10">
					...
					<p class="card-category">Omset Rp. <?=$this->func->formUang($omsetlalu)?></p>
				</div>
			</div>
		</div>
	</div>
				...
				<?php
					if(count($dropship) > 0){
						...
						foreach($dropship as $key => $val){
							if($no <= 5){
							$usr = $this->func->getProfil($key,"semua","usrid");
				?>
					<div class="row m-b-10">
						<div class="col-2 align-items-center fs-40"><i class="fas fa-user-circle"></i></div>
						<div class="col-10">
...
<script type="text/javascript">
	$(function(){
		...
		var dataSales = {
			...
			series: [
			{name: "pcs",data:[<?=implode(",",$pcsfix)?>]},
			{name: "nota",data:[<?=implode(",",$notafix)?>]}
			]
		}
