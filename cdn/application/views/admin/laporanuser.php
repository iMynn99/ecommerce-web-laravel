    ...
    <div class="card">
        <div class="card-header">
            <div class="row" style="align-items:center;">
                <div class="col-md-6 m-b-10" style="font-size:120%;"><i class="fas fa-filter"></i> &nbsp;Periode Laporan
                </div>
                <div class="col-md-6 text-right">
                    <!--<button onclick="saveDiv('load','Laporan Penjualan')" class="btn btn-warning"><i class="fas fa-file-pdf"></i> Download PDF</button>-->
                    <button onclick="printDiv('load','Laporan Penjualan')" class="btn btn-primary"><i
            ...
            <div class="row" style="align-items:center;">
                <div class="col-12 row m-t-10" style="align-items:center;">
                    ...
                    <div class="col-md-8 m-t-10 p-lr-5" style="margin-left: -77px;">
            ...
            <div class="row" style="align-items:center;">
                <div class="col-12 col-md-4 row m-t-20" style="align-items:center;">
                    ...
                    <input type="text" id="tglmulai" class="form-control datepicker col-8"
                        value="<?=date("Y-m-d",strtotime("-30 day", strtotime(date("Y-m-d"))))?>" />
                </div>
                <div class="col-12 col-md-4 row m-t-20" style="align-items:center;">
                    <div class="col-4">Selesai</div>
                    <input type="text" id="tglselesai" class="form-control datepicker col-8"
                        value="<?=date("Y-m-d")?>" />
                </div>
            </div>
        </div>
...
function loadUser(level) {
    $.post("<?=site_url("api/getusrid")?>?level=" + level, {
...
function loadRiwayat() {
    ...
    $.post("<?=site_url("ngadimin/laporanuser?load=hal")?>", {
        "usrid": $("#usrid").val(),
