<html lang="ID">
	<head>
		...
		<link rel="shortcut icon" type="image/png" href="<?php echo base_url("assets/img/".$this->func->globalset("favicon")); ?>"/>
	...
	<body style="background:#ecf0f1;font-family: 'Poppins', sans-serif;">
		<div class="loginlogo">
